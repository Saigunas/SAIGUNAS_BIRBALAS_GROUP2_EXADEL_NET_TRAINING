...
{
    public class TaskValidator : AbstractValidator<TaskManagementSystem.Domain.Task>
    {
        ...
        public bool CheckIfCreatorExists(TaskManagementSystem.Domain.Task task)
        {
        ...
        public bool CheckIfPerformerIdExists(TaskManagementSystem.Domain.Task task)
        {
            using (var db = new TaskManagementContext())
            {
        ...
        public bool CheckRoleValidity(TaskManagementSystem.Domain.Task task)
        {
            using (var db = new TaskManagementContext())
            {
                User creator = db.Users.FirstOrDefault(t => t.Id == task.CreatorId);
        ...
        public bool CheckPerformer(TaskManagementSystem.Domain.Task task)
        {
            using (var db = new TaskManagementContext())
            {
                if (task.PerformerId == null)
